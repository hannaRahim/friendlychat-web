...
addMessage = async (
  ...
  loadMessages_versi_ori = () => {
    ...
    saveImageMessage_version_old = async (file: any) => {};
  ...
  requestNotificationsPermissions_version_ori = async () => {};
  ...
  saveMessagingDeviceToken_version_ori = async () => {};
